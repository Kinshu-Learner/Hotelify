    ...
    <div className="flex flex-col gap-4">
      ...
      <label className="text-gray-700 text-sm font-bold max-w-[50%]">
        ...
        <select
          ...
          className="border rounded w-full p-2 text-gray-700 font-normal focus:outline-none focus:border-indigo-500"
        >
        ...
        {errors.starRating && (
          <span className="text-yellow-600">{errors.starRating.message}</span>
        )}
      </label>
    </div>
  );
